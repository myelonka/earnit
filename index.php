				...
				<div id="reg-form">
					<form action="" method="POST">
						<table>
							...
							<tr>
								<td></td>
								<td><input type="password" name="paswword-conf" placeholder="confirm password" required></td>
								<br>
							</tr>
							<tr>	
								<td></td>
								<td>
									<br>
									<button type="submit" id="reg-signupbtn">Sign Up</button>
									<h6>Already have an account?&nbsp;</h6>
									<a href="" id="reg-loginbtn">Sign In</a>
								</td>
							</tr>
						</table>
					</form>
